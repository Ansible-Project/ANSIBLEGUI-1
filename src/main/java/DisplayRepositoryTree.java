...
public class DisplayRepositoryTree {
    ...
    public static void main(String[] args) {
    	...
    	//String mongodbUrl = env.getProperty("jdbc.url");
    	System.out.println(propertyValue);
        /*
         * default values:
         */
        String url = "https://repo.vitechinc.com/repos/deployment/trunk/DevOpsScripts/Ansible_Scripts/WLS-JDK-Patching/roles/";
        String name = "pmatta";
        String password = "Srinu@2727";
